...
class LogManager implements LoggerInterface
{
    ...
    {
        return new Monolog('OpenDota', $this->prepareHandlers([new StreamHandler(
            \sys_get_temp_dir().'/opendota/opendota.log', $this->level(['level' => 'debug'])
        )]));
    }
